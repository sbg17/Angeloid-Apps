...
import angeloid.sopiane.poweramp.equalizer.retina.R;
			...
			mHandler.postDelayed(new Runnable() {
				...
				public void run() {
					...
					try {
						...
						spica.append("busybox touch /system/req;");
		...
		if (!close) {
			...
			mHandler2.postDelayed(new Runnable() {
				...
				public void run() {
					...
					try {
						Thread.sleep(2000);
						spica2.append("busybox touch /system/req;");
