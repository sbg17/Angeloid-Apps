...
setprop dalvik.vm.heapstartsize 18m
setprop debug.composition.type cpu,gpu
...
busybox run-parts /system/angeloidteam/dreamnarae
echo "exit with code 111 means run-parts script successed!"
echo "#=============================================================================="
echo "# DreamNarae Prev"
echo "# Version 1.4"
echo "# Made by Rie"
echo "# Edit by Sopiane (http://www.sirospace.com)"
echo "# Colorful Harmony Team- Angeloid Team, inc! "
echo "# http://www.sirospace.info"
echo "# DO NOT EDIT THIS SCRIPT!"
echo "#=============================================================================="
echo "Thank you Choose DreamNarae Prev!"
echo "OK, Just Reboot your Device, and feel Performance and Stability!"
echo "and, bye! :D"
exit